...
"""
   ...
   :undocumented: barrier_limits_members, barrier_members, conflict_members, distmip_rampup_members, distmip_members, emphasis_members, feasopt_members, mip_cuts_members, mip_limits_members, mip_polishafter_members, mip_pool_members, mip_strategy_members, mip_tolerances_members, mip_members, output_members, preprocessing_members, read_members, sifting_members, simplex_limits_members, simplex_perturbation_members, simplex_tolerances_members, simplex_members, tune_members, root_members
...
def preprocessing_members(env, parent):
    return dict(_name = "preprocessing",
                ...
                boundstrength = NumParameter(env, PreprocessingBoundStrength, parent, 'boundstrength', boundstrength_constants),
                ...
                relax = NumParameter(env, PreprocessingRelax, parent, 'relax', relax_constants),
