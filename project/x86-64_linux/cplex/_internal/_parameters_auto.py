...
DistMIPRampupTimeLimit  = [ CPX_PARAM_RAMPUPTILIM  ,  "wallclock time-limit on rampup  :\n  0 = automatic\n  >0 = time in seconds" ]
...
TuneDetTimeLimit  = [ CPX_PARAM_TUNINGDETTILIM  ,  "deterministic time limit per model and per test setting " ]
